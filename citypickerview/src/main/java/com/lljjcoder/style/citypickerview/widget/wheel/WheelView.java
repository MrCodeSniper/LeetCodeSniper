...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[] { 0xef1F1F1F, 0xef1F1F1F, 0xef1F1F1F };

//    private int[] SHADOWS_COLORS = new int[] { 0xefFFFFFF, 0xefFFFFFF, 0xefFFFFFF };
    ...
    private void initData(Context context) {
        int shadowColor =  context.getResources().getColor(R.color.gov_shadow_color);
        SHADOWS_COLORS = new int[] { shadowColor, shadowColor, shadowColor };
    ...
    private void drawShadows(Canvas canvas) {
        ...
        topShadow.setBounds(0, 0, getWidth(), center - offset - padding);
        topShadow.draw(canvas);
        
        bottomShadow.setBounds(0, center + offset + padding, getWidth(), getHeight());
