...
public class CustomConfig {
     ...
     * 标题背景
     */
    private int titleBackgroundBgRes = -1;
    ...
    public int getTitleBackgroundRes() {
        return titleBackgroundBgRes;
    }

    public void setTitleBackgroundRes(int bgRes) {
        this.titleBackgroundBgRes = bgRes;
    }
    ...
    public CustomConfig(Builder builder) {
        ...
        this.titleBackgroundBgRes = builder.titleBackgroundRes;
//
        /**
    ...
    public static class Builder {
        ...
        public Builder titleBackgroundRes(int bgRes) {
            this.titleBackgroundRes = bgRes;
            return this;
        }
