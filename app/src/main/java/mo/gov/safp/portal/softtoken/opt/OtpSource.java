...
public interface OtpSource {
   ...
   */
  String getNextCode(AccountDb.AccountIndex account) throws OtpSourceException;
   ...
   */
  String respondToChallenge(AccountDb.AccountIndex account, String challenge) throws OtpSourceException;
